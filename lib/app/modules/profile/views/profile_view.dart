                                      ...
                                      : Column(
                                          children: [
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                Text(
                                                  (profileController.profileData.phone != null && profileController.profileData.phone.toString().isNotEmpty)
                                                      ? profileController.profileData.countryCode! + profileController.profileData.phone.toString()
                                                      : '', // If phone number is empty, show an empty string
                                                  style: TextStyle(
                                                    fontFamily: 'Rubik',
                                                    fontSize: 14.sp,
                                                    color: AppColor.gray,
