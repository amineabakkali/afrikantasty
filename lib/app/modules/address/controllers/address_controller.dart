...
class AddressController extends GetxController {
  ...
  List<String> addressTypeList = ['Domicile', 'Travail', 'Autre'];
  String selectedAddressType = "Domicile";
  ...
  void setAddressTypeIndex(int index) {
    ...
    if (selectedAddressType.toString() == "Autre") {
  ...
  updateAddress(
    ...
    if (address.isNotEmpty) {
      editAddress(label, address, pickPosition.latitude.toString(),
