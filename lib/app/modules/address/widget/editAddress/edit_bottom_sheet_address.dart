...
class _EditAddressViewState extends State<EditBottomSheetAddress> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.addressData!.address == null) {
      addressInputController.text = "";
    } else {
      addressInputController.text = widget.addressData!.address!;
    }
            ...
            child:
                  ...
                  children: [
                    ...
                    InkWell(
                      child: SizedBox(
                        ...
                        width: 290.w,
                        child: Text(
                          addressInputController.text.toString(),
                          style: TextStyle(
                            fontFamily: 'Rubik',
              ...
              Column(
                ...
                children: [
                  ...
                  if (widget.addressData!.label!.toString() != "Domicile" &&
                      widget.addressData!.label!.toString() != "Travail")
                    Padding(
