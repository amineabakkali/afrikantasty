...
class _ItemViewState extends State<ItemView> {
  ...
  addItemAddons(id, itemId, name, category, price, qty, image, variationTotal) {
    addonList.add(
      Addons(
          id: id,
          itemId: itemId,
  ...
  Widget build(BuildContext context) {
    final double cardHeight = MediaQuery.of(context).size.height * 0.11; // Adjust the multiplier as needed
    final double cardWidth = MediaQuery.of(context).size.width * 0.11; // Adjust the multiplier as needed
                  ...
                  children: [
                    ...
                    //Addons section,
                      if (widget.itemDetails!.addons!.isNotEmpty)
                        Padding(
                          padding: EdgeInsets.only(top: 8.h, bottom: 24.h, left: 16.w, right: 8.w),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(
                                "Boissons Fraiches".tr,
                                style: TextStyle(
                                  fontFamily: 'Rubik',
                                  fontWeight: FontWeight.w500,
                                  fontSize: 14.sp,
                              ...
                              SizedBox(
                                ...
                                child: SingleChildScrollView(
                                  ...
                                  child: ListView.builder(
                                    shrinkWrap: true,
                                    scrollDirection: Axis.horizontal,
                                    itemCount: widget.itemDetails!.addons!.length,
                                    itemBuilder: (BuildContext context, index) {
                                      var addonItem = widget.itemDetails!.addons![index];
                                      if (addonItem.categoryAddon == "LES BOISSONS SODAS") { // Condition to check categoryAddon value
                                        return Padding(
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              color: cartController.selectedAddOnsIndex.contains(index)
                                                  ? AppColor.primaryColor.withOpacity(0.08)
                                                  : Colors.white,
                                              border: cartController.selectedAddOnsIndex.contains(index)
                                                  ? Border.all(color: AppColor.primaryColor)
                                                  : Border.all(color: AppColor.itembg),
                                            ),
                                            child: Row(
                                              mainAxisAlignment: MainAxisAlignment.start,
                                              children: [
                                                ...
                                                Padding(
                                                  padding: EdgeInsets.only(left: 8.w, top: 0.h, right: 8.w),
                                                  child: SizedBox(
                                                    height: 70.h,
                                                    width: 160.w,
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        Row(
                                                          ...
                                                          children: [
                                                            InkWell(
                                                              onTap: () {
                                                                if (cartController.selectedAddOnsIndex.contains(index)) {
                                                                  cartController.selectedAddOnsIndex.remove(index);
                                                                  removeAddonFromCart(addonItem.itemAddonId);
                                                                } else {
                                                                  cartController.selectedAddOnsIndex.add(index);
                                                                  if (addonList.every((item) => item.id != addonItem.itemAddonId)) {
                                                                    addItemAddons(
                                                                      addonItem.itemAddonId,
                                                                      addonItem.itemId,
                                                                      addonItem.addonItemName,
                                                                      addonItem.categoryAddon,
                                                                      addonItem.addonItemConvertPrice.toString(),
                                                                      addOnsQuantity,
                                                                      addonItem.cover,
                                                                      addonItem.variationTotalConvertPrice.toString(),
                                                                    );
                                                                  }
                                                                }
                                                                calculate();
                                                              ...
                                                              child: SizedBox(
                                                                width: 140.w,
                                                                child: Text(
                                                                  addonItem.addonItemName.toString(),
                                                                  style: TextStyle(
                                                                    fontFamily: 'Rubik',
                                                                    fontWeight: FontWeight.w500,
                                                                    fontSize: 12.sp,
                                                          ...
                                                          children: [
                                                            SizedBox(
                                                              ...
                                                              child: ListView.builder(
                                                                shrinkWrap: true,
                                                                scrollDirection: Axis.horizontal,
                                                                itemCount: addonItem.variationNames!.length,
                                                                itemBuilder: (BuildContext context, addonIndex) {
                                                                  return Text(
                                                                    "${addonItem.variationNames![addonIndex].name.toString()} , ",
                                                                    style: TextStyle(
                                                                      fontFamily: 'Rubik',
                                                        ...
                                                        SizedBox(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              Text(
                                                                addonItem.totalCurrencyPrice!.toString(),
                                                                style: fontRegularBold,
                                                                maxLines: 1,
                                                                overflow: TextOverflow.ellipsis,
                                                              ),
                                                              cartController.selectedAddOnsIndex.contains(index)
                                                                  ? SizedBox(
                                                                height: 20.h,
                                                                width: 70.w,
                                                                child: Row(
                                                                  ...
                                                                  children: [
                                                                    InkWell(
                                                                      onTap: () {
                                                                        int i = addonList.indexWhere((e) => e.id == addonItem.itemAddonId);
                                                                        int qty = addonList[i].quantity!;
                                                                        if (qty > 1) {
                                                                          qty--;
                                                                          removeItemAddons(
                                                                            addonItem.itemAddonId,
                                                                    ...
                                                                    addonList.isNotEmpty
                                                                        ? Text('${addonList[addonList.indexWhere((e) => e.id == addonItem.itemAddonId)].quantity!}',
                                                                        style: fontMedium)
                                        ...
                                        return SizedBox.shrink(); // If categoryAddon is not "test", return an empty SizedBox
                                      }
                                    },
                                  ),
                                ),
                            ...
                            SizedBox(
                              ...
                              child: SingleChildScrollView(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (BuildContext context, index) {
                                    var addonItem = widget.itemDetails!.addons![index];
                                    if (addonItem.categoryAddon == "LES CONFISERIES" || addonItem.categoryAddon == "LES DESSERTS" || addonItem.categoryAddon == "TIRAMISU XXL") { // Condition to check categoryAddon value
                                      return Padding(
                                        padding: EdgeInsets.only(right: 9.w),
                                        child: Container(
                                          height: 80.h,
