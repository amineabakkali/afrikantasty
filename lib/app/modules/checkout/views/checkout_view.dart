  ...
  void initState() {
    ...
    if (addressController.addressDataList.isNotEmpty) {
     ...
     /* addressLat = double.parse(
      ...
      addressLat = double.parse("0.0");
      addressLon = double.parse("0.0");
                      ...
                      child: Column(
                        children: [
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: addressController.addressDataList[index].label.toString() ==
                                                                    ...
                                                                    width: 15.w,
                                                                      ...
                                                                      : addressController.addressDataList[index].label.toString() == "Travail"
                                                                      ? SvgPicture.asset(
                                                                    Images.work,
                                                                    fit: BoxFit.cover,
                                                                  )
                          ...
                          GetBuilder<CheckoutController>(
                            builder: (checkoutController) => Visibility(
                              visible: false,
                              child: Padding(
                                padding: EdgeInsets.only(left: 16.w, bottom: 24.w, right: 8.w),
                                child: Column(
                                  children: [
                                    Row(
                                      children: [
                                          ...
                                          child: ListView.builder(
                                            ...
                                            itemBuilder: (context, index) {
                                              return TimeSlotWidget(
                                                ...
                                                isSelected: checkoutController.selectDateSlot == index,
                                                onTap: () {
                                                  checkoutController.updateDateSlot(index);
                                                },
                                              );
                                            },
                                          ),
                                    ...
                                    if (checkoutController.selectDateSlot == 0)
                                      Container(
                                        alignment: Alignment.centerLeft,
                                        height: 40.h,
                                        child: checkoutController.todayDataList != null
                                            ? checkoutController.todayDataList.isNotEmpty
                                            ? ListView.builder(
                                          scrollDirection: Axis.horizontal,
                                          shrinkWrap: true,
                                          physics: const BouncingScrollPhysics(),
                                          itemCount: checkoutController.todayDataList.length,
                                          itemBuilder: (context, index) {
                                            return TimeSlotWidget(
                                              title: (index == 0 &&
                                                  checkoutController.selectDateSlot == 0
                                                  ? 'NOW'.tr
                                                  : checkoutController.todayDataList[index]
                                                  .label!),
                                              isSelected: checkoutController.selectTimeSlot ==
                                                  index,
                                              onTap: () {
                                                selectedDate =
                                                checkoutController.todayDataList[index].time!;
                                                isAdvanceOrder = 10;
                                    ...
                                    if (checkoutController.selectDateSlot == 1)
                                      Container(
                                        alignment: Alignment.centerLeft,
                                        height: 40.h,
                                        child: checkoutController.tomorrowDataList != null
                                            ? checkoutController.tomorrowDataList.isNotEmpty
                                            ? ListView.builder(
                                          scrollDirection: Axis.horizontal,
                                          shrinkWrap: true,
                                          physics: const BouncingScrollPhysics(),
                                          itemCount: checkoutController.tomorrowDataList.length,
                                          itemBuilder: (context, index) {
                                            return TimeSlotWidget(
                                              title: checkoutController.tomorrowDataList[index]
                                                  .label!,
                                              isSelected: checkoutController.selectTimeSlot ==
                                                  index,
                                              onTap: () {
                                                selectedDate = checkoutController
                                                    .tomorrowDataList[index].time!;
                                                isAdvanceOrder = 5;
                                                checkoutController.updateTimeSlot(index);
                                              },
                                            );
